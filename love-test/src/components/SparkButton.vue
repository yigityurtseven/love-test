<template>
    <div class="sparkle-button">
        ...
        <button>
            ...
            <span class="text">Calculate Love</span>
        </button>
...
body {
    --active: 0;
    background: hsl(300 calc(var(--active) * 97%) 6%);
    display: grid;
    place-items: center;
    min-height: 100vh;
...
button {
    ...
    --bg:
        radial-gradient(40% 50% at center 100%,
            hsl(310 calc(var(--active) * 97%) 72% / var(--active)),
            transparent),
    ...
    position: relative;
    box-shadow:
        0 0 calc(var(--active) * 6em) calc(var(--active) * 3em) hsla(339, 97%, 61%, 0.75),
        0 0.05em 0 0 hsl(320 calc(var(--active) * 97%) calc((var(--active) * 50%) + 30%)) inset,
        0 -0.05em 0 0 hsl(320 calc(var(--active) * 97%) calc(var(--active) * 60%)) inset;
...
button:before {
    ...
    inset: -0.25em;
    z-index: -1;
    border: 0.25em solid hsl(320 97% 50% / 0.5);
    border-radius: 100px;
...
.bodydrop {
    background: hsl(320 calc(var(--active) * 97%) 6%);
    position: fixed;
    inset: 0;
    z-index: -1
}
